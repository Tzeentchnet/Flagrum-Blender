...
class ElementFormat(IntEnum):
    ...
    def get_count(element):
        if element.format == ElementFormat.XYZ32_Float:
            ...
            return 2
        elif element.format == ElementFormat.XYZW8_UintN or element.format == ElementFormat.XYZW8_Uint:
            return 4
        elif element.format == ElementFormat.XYZW8_SintN or element.format == ElementFormat.XYZW8_Sint:
            return 4
        elif element.format == ElementFormat.XYZW16_Uint:
            return 4
        elif element.format == ElementFormat.XYZW32_Uint:
