...
class NormaliseWeightsOperator(Operator):
    ...
    bl_description = (
        "Normalises vertex weights to the limits defined by the selected Flagrum materials to "
...
class CleanupPanel(Panel):
    ...
    def draw(self, context):
        ...
        row.prop(
            context.window_manager.flagrum_globals,
            property="retain_base_armature",
